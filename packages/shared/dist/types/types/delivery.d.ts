...
export declare const TERMINAL_STATUSES: StopStatus[];
export declare const isTerminalStatus: (status: string) => boolean;
export type FailureReason = 'not_home' | 'refused' | 'wrong_address' | 'patient_hospitalized' | 'safety_concern' | 'inaccessible' | 'other';
