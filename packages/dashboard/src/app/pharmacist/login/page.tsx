    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F0FDF4]">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-emerald-100 p-8">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            <label htmlFor="pharmacist-email" className="block text-sm font-medium text-gray-700 mb-1">Email</label>
            <input
              id="pharmacist-email"
              type="email"
              autoComplete="email"
          ...
          <div>
            <label htmlFor="pharmacist-password" className="block text-sm font-medium text-gray-700 mb-1">Password</label>
            <input
