      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="overflow-y-auto flex-1 p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Schedule */}
            <div>
              <label htmlFor="recurring-schedule" className="block text-xs font-medium text-gray-600 mb-1">Schedule</label>
              <select id="recurring-schedule" value={form.schedule} onChange={e => set('schedule', e.target.value)}
